        ...
        <div className="space-y-8 relative">
            ...
            <div>
                ...
                <p className="text-zinc-400 text-sm mt-1">
                    Aggregate student performance, active focus areas, and spaced learning metrics.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    { label: "Active Engagement", val: "84.2%", desc: "Student logins past 2d", color: "text-indigo-400" },
                    { label: "Average Retention", val: "81.6%", desc: "Leitner card validation success", color: "text-emerald-400" },
                    { label: "Average Quiz Score", val: "73.4%", desc: "Against 56 attempts", color: "text-amber-400" },
                    { label: "AI Suggestions Sent", val: "14 DirectIVES", desc: "For weak-topics reviews", color: "text-pink-400" },
                ].map((m, i) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 p-6 rounded-3xl bg-[#0d0d1e] border border-white/5 shadow-xl space-y-6">
                    <div className="flex justify-between items-center">
                        <div>
                            <h3 className="text-sm font-bold text-white">Daily Quiz Completion Curve</h3>
                ...
                <div className="p-6 rounded-3xl bg-[#0d0d1e] border border-white/5 shadow-xl space-y-6">
                    ...
                    <div className="space-y-4">
                        {[
                            { name: "Inertial Mechanics", percent: 84, color: "bg-emerald-500" },
                            { name: "Quantum Energy Boundaries", percent: 79, color: "bg-indigo-500" },
                            { name: "Gaussian Algebra Methods", percent: 52, color: "bg-red-500 animate-pulse" },
                            { name: "Forces & Motion Vector", percent: 68, color: "bg-amber-500" },
                        ].map((topic, i) => (
                    ...
                    <button
                        onClick={() => triggerToast("Compiling full CSV study record for direct class reports download...")}
